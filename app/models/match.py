...
class Match(Base):
    ...
    # Relationships
    home_team = relationship("Team", foreign_keys=[home_team_name], back_populates="home_matches")
    away_team = relationship("Team", foreign_keys=[away_team_name], back_populates="away_matches")
